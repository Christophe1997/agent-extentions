...
Key refactorings (see `/tdd:tdd-patterns` for full list):
...
- **`/tdd:tdd-patterns`** — All 40+ patterns from Part III of the book (Red Bar, Testing, Green Bar, xUnit, Design, Refactoring patterns)
- **`/tdd:tdd-review`** — Review existing code or tests for TDD compliance and quality
